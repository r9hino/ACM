<template>
    ...
    <div class="container-sm flex-column mt-2">
        ...
        <div class="d-flex justify-content-between align-items-center mx-2" v-for="relay in relays" :key="relay.id">
            ...
            <div class="d-inline-flex justify-content-center align-items-center">
                ...
                <button class="btn btn-outline-secondary d-flex align-items-center px-1" type="button" style="height: 33.5px" @click.prevent="showModal = true">
    ...
    <teleport to="body" v-if="showModal">
        <ModalSchedule @closeModal="showModal = false;">
