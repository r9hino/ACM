    ...
    <div class="container-fluid">
      ...
      <div class="navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <router-link class="routerLink" to="/alerts" @click="setToolActiveClass(false)">Alerts</router-link>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdown">
              ...
              <li><router-link class="routerLink" to="/guardusers" @click="setToolActiveClass(true)">Guard Users</router-link></li>
